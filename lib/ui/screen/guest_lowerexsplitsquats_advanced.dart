...
import 'package:fitness_forge/ui/screen/guest_lowercircuit_advanced.dart';
...
class GuestLowerExplosiveSplitSquadsScreenAdvanced extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestLowerExplosiveSplitSquadsScreenAdvanced> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestLowerCircuitScreenAdvanced(),
                    ),
                  );
                },
              ),
