import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_sideplank_standard.dart';
import 'package:fitness_forge/ui/screen/sideplank_standard.dart';
import 'package:flutter/material.dart';

class GuestSitupsScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestSitupsScreenStandard> {
  int countdown = 30;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.0),
              Image.asset(
                'images/situps.png', // Replace with the actual path to your image
                width: 200.0,
                height: 200.0,
              ),
              SizedBox(height: 16.0),
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestSidePlankScreenStandard(),
                    ),
                  );
                },
              ),
