...
import 'package:fitness_forge/ui/screen/guest_loweronelegsquats_advanced.dart';
...
class GuestLowerExplosiveSquatsScreenAdvanced extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestLowerExplosiveSquatsScreenAdvanced> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestLowerOneLegSquatsScreenAdvanced(),
                    ),
                  );
                },
              ),
