...
import 'package:fitness_forge/ui/screen/guest_lowerexcalfraises_advanced.dart';
...
class GuestLowerCircuitScreenAdvanced extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestLowerCircuitScreenAdvanced> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestLowerExplosiveCalfRaisesScreenAdvanced(),
                    ),
                  );
                },
              ),
