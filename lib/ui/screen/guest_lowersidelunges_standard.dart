import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_lowersplitsquats_standard.dart';
...
class GuestLowerSideLungesScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestLowerSideLungesScreenStandard> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestLowerSplitsSquatsScreenStandard(),
                    ),
                  );
                },
              ),
