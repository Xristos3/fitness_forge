...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {
        '/': (context) => GuestPlankStandardScreen(),
        '/buttkickstandardScreen': (context) => GuestCongratulationsScreen(),
      },
    );
  }
}
...
class _CountdownScreenState extends State<GuestPlankStandardScreen> {
  int _seconds = 40;
  Timer? _timer;
