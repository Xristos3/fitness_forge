import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_lowercalfraises_standard.dart';
import 'package:fitness_forge/ui/screen/lowercalfraises_standard.dart';
import 'package:fitness_forge/ui/screen/reversesnow_standard.dart';
import 'package:flutter/material.dart';

class GuestLowerCircuitScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestLowerCircuitScreenStandard> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestLowerCalfRaisesScreenStandard(),
                    ),
                  );
                },
              ),
