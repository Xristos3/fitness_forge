import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_tricepdips_advanced.dart';
import 'package:fitness_forge/ui/screen/situps_standard.dart';
import 'package:fitness_forge/ui/screen/tricepdips_advanced.dart';
import 'package:flutter/material.dart';

class GuestDiamondPressScreenAdvanced extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestDiamondPressScreenAdvanced> {
  int countdown = 30;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.0),
              Image.asset(
                'images/diamond.jpeg', // Replace with the actual path to your image
                width: 200.0,
                height: 200.0,
              ),
              SizedBox(height: 16.0),
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestTricepDipScreenAdvanced(),
                    ),
                  );
                },
              ),
