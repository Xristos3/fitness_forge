import 'dart:async';
import 'package:fitness_forge/ui/screen/dragonwalk_standard.dart';
import 'package:fitness_forge/ui/screen/guest_dragonwalk_standard.dart';
import 'package:flutter/material.dart';

class GuestTricepsExtensionScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestTricepsExtensionScreenStandard> {
  int countdown = 30;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.0),
              Image.asset(
                'images/tes.jpeg', // Replace with the actual path to your image
                width: 200.0,
                height: 200.0,
              ),
              SizedBox(height: 16.0),
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestDragonWalkScreenStandard(),
                    ),
                  );
                },
              ),
