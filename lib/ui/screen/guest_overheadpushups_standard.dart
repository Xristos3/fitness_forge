import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_plankupper_standard.dart';
import 'package:fitness_forge/ui/screen/plankupper_standard.dart';
import 'package:flutter/material.dart';

class GuestOverheadPushupScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestOverheadPushupScreenStandard> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestPlankUpperScreenStandard(),
                    ),
                  );
                },
              ),
