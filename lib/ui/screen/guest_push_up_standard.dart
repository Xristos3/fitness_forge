import 'dart:async';
import 'package:fitness_forge/ui/screen/birddoghold_standard.dart';
import 'package:fitness_forge/ui/screen/guest_birddoghold_standard.dart';
import 'package:flutter/material.dart';

class GuestPushUpUpperScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestPushUpUpperScreenStandard> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestBirdDogHoldScreenStandard(),
                    ),
                  );
                },
              ),
