import 'package:fitness_forge/ui/screen/guest_congratulationchallenges.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:fitness_forge/ui/screen/challenges_congratulations.dart';

class GuestRockClimbing extends StatefulWidget {
  @override
  _GuestRockClimbingState createState() => _GuestRockClimbingState();
}

class _GuestRockClimbingState extends State<GuestRockClimbing> {
  ...
  void navigateToNextScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => GuestCongratulationsChallengeScreen()),
    );
  }
}
