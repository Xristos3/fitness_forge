import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_superman_advanced.dart';
import 'package:fitness_forge/ui/screen/situps_standard.dart';
import 'package:fitness_forge/ui/screen/superman_advanced.dart';
import 'package:flutter/material.dart';

class GuestDolphinKicksScreenAdvanced extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestDolphinKicksScreenAdvanced> {
  int countdown = 30;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16.0),
              Image.asset(
                'images/dolphin.jpeg', // Replace with the actual path to your image
                width: 200.0,
                height: 200.0,
              ),
              SizedBox(height: 16.0),
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestSupermanScreenAdvanced(),
                    ),
                  );
                },
              ),
