import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_lowersidelunges_standard.dart';
...
class GuestLowerSquatsScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestLowerSquatsScreenStandard> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestLowerSideLungesScreenStandard(),
                    ),
                  );
                },
              ),
