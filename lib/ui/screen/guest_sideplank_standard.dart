import 'dart:async';
import 'package:fitness_forge/ui/screen/guest_reversesnow_standard.dart';
import 'package:fitness_forge/ui/screen/reversesnow_standard.dart';
import 'package:flutter/material.dart';

class GuestSidePlankScreenStandard extends StatefulWidget {
  @override
  _PushUpUpperScreenStandardState createState() =>
      _PushUpUpperScreenStandardState();
}

class _PushUpUpperScreenStandardState extends State<GuestSidePlankScreenStandard> {
  int countdown = 30;
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => GuestReverseSnowAngelsScreenStandard(),
                    ),
                  );
                },
              ),
